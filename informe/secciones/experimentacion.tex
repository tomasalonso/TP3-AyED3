...
\todo[inline]{Notamos que si bien los equipos hacían goles y algún equipo ganaba, al hacerlos empezar del lado contrario al tablero}



% \todo[inline]{VER POR QUÉ CAMBIA EL RESULTADO DE LOS PARTIDOS DEPENDIENDO DEL LADO EN QUE EMPIECEN}

\subsubsection*{Crossover: Bloques vs. Aleatoio (6 (Izq) - 4(Der))}

Los equipos no tienen mucho problema para anotar goles.
...
\subsubsection*{Fitness: Puntos (torneo) vs. Diferencia de goles ( - )}
