...
Agregamos entonces el genoma que relaciona a los jugadores con su distancia a la pelota, para que tuvieran una mejor visión del campo de juego.
Una gran barrera también fue el tiempo, pues aumenta muy rápidamente el requerido por cada generación si se agrandan las poblaciones.
